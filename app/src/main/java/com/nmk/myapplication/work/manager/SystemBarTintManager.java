...
public class SystemBarTintManager {
    ...
    public static boolean setStatusBarDarkMode(boolean darkmode, Window window) {
        ...
        else if (VERSION.SDK_INT >= VERSION_CODES.KITKAT && !darkmode) {
            flag = true;
        }
        return flag;
    }
    ...
    public void setStatusBarAlpha(float alpha) {
        if (mStatusBarAvailable && VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB) {
    ...
    public void setNavigationBarAlpha(float alpha) {
        if (mNavBarAvailable && VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB) {
    ...
    private void setupStatusBarView(Context context, ViewGroup decorViewGroup) {
        ...
        if (mNavBarAvailable && !mConfig.isNavigationAtBottom()) {
            params.setMarginEnd(mConfig.getNavigationBarWidth());
        }
    ...
    public static boolean setImmersedWindow(Context context, Window window, boolean immersive, int statusColorResouce) {
        ...
        if (window != null) {
            ...
            } else if (VERSION.SDK_INT >= VERSION_CODES.KITKAT && VERSION.SDK_INT < VERSION_CODES.LOLLIPOP) {
