package com.nmk.myapplication.work.utils
...
private fun <VB : ViewBinding> withGenericBindingClass(any: Any, block: (Class<VB>) -> VB): VB {
    ...
    // 检查是否是 merge 标签的情况
    if (genericSuperclass is ParameterizedType && genericSuperclass.rawType == ViewStub::class.java) {
        // 获取 ViewStub 的父类
        genericSuperclass = genericSuperclass.ownerType as? ParameterizedType
    }
