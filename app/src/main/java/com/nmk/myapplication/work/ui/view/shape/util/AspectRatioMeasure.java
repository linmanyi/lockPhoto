package com.nmk.myapplication.work.ui.view.shape.util;
...
/**
 * @author H-ray
 * @desc：根据aspectRatio（宽/高），计算View宽高 <p>参考com.facebook.drawee.view.AspectRatioMeasure</p>
...
public class AspectRatioMeasure {
    ...
    public static class Spec {
        public Spec(int width, int height) {
            this.width = width;
            this.height = height;
        }
     ...
     * match the measure spec of the other dimension adjusted by the aspect ratio. Exactly one
     * layout
     ...
     * if
     * the parent has specified mode {@code EXACTLY}, and it doesn't exceed measure size if parent
     * has
